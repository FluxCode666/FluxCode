...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, generatedImageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, pricingPlanHandler, poolMonitorHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, paymentHandler, referralHandler, salesCommissionHandler, promotionHandler)
	...
	modelPricingPageService := service.NewModelPricingPageService(channelService, groupService, billingService)
	modelPricingHandler := handler.NewModelPricingHandler(modelPricingPageService)
	handlerPricingPlanHandler := handler.NewPricingPlanHandler(pricingPlanService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, modelPricingHandler, handlerPricingPlanHandler, handlerPaymentHandler, paymentWebhookHandler, handlerReferralHandler, handlerSalesCommissionHandler, channelMonitorUserHandler, idempotencyCoordinator, idempotencyCleanupService)
