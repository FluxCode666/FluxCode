...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userHandler := handler.NewUserHandler(userService, uiPreferencesService, emailService, emailCache)
	...
	gatewayService.SetPoolMonitorService(poolMonitorService)
	openAIGatewayService.SetPoolMonitorService(poolMonitorService)
	geminiMessagesCompatService.SetPoolMonitorService(poolMonitorService)
