...
func provideCleanup(
	...
	giftBalanceExpiry *service.GiftBalanceExpiryService,
) func() {
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"GiftBalanceExpiryService", func() error {
				if giftBalanceExpiry != nil {
					giftBalanceExpiry.Stop()
				}
				return nil
			}},
		}
