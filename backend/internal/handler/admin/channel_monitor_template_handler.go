...
func (h *ChannelMonitorRequestTemplateHandler) List(c *gin.Context) {
	...
	for _, item := range items {
		out = append(out, h.toResponse(c, item))
	}
...
func (h *ChannelMonitorRequestTemplateHandler) Get(c *gin.Context) {
	...
	tpl, err := h.templateService.Get(c.Request.Context(), id)
	if err != nil {
		response.ErrorFrom(c, err)
		return
	}
...
func (h *ChannelMonitorRequestTemplateHandler) Create(c *gin.Context) {
	...
	tpl, err := h.templateService.Create(c.Request.Context(), service.ChannelMonitorRequestTemplateCreateParams{
		Name:             req.Name,
	...
	response.Created(c, h.toResponse(c, tpl))
}
...
func (h *ChannelMonitorRequestTemplateHandler) Update(c *gin.Context) {
	...
	tpl, err := h.templateService.Update(c.Request.Context(), id, service.ChannelMonitorRequestTemplateUpdateParams{
		Name:             req.Name,
		APIMode:          req.APIMode,
		Description:      req.Description,
		ExtraHeaders:     req.ExtraHeaders,
