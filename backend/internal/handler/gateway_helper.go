...
// TryAcquireUserSlotForAPIKey records API Key concurrency only after the user
// slot has been acquired successfully, so queued or rejected requests are not
// counted as active traffic.
