...
func NewUserHandler(userService *service.UserService, uiPreferencesService *service.UserUIPreferencesService, emailService *service.EmailService, emailCache service.EmailCache) *UserHandler {
	return &UserHandler{
