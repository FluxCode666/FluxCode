...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, userAccessKeyAuth, apiKeyService, subscriptionService, opsService, settingService, successfulRequestRecordService, cfg, redisClient)
}
