		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyEmailProvider:  "smtp",
					service.SettingKeyResendAPIKey:   "resend-secret",
					service.SettingKeyResendFrom:     "resend@example.com",
					service.SettingKeyResendFromName: "Resend Sender",
			...
			wantJSON: `{
				...
				"data": {
					...
					"resend_from_name": "Resend Sender",
...
func (stubGroupRepo) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, status, search string, isExclusive *bool, _ string) ([]service.Group, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
