...
// StartOpenAICompactSSEKeepalive keeps body-signal compact SSE clients alive
// while the upstream unary /responses/compact request is still running.
...
// whether it had already committed the downstream HTTP response as 200.
...
// OpenAICompactKeepaliveAdjustedWrittenSize excludes heartbeat comments from
// the writer size used to decide whether failover/replay is still safe.
