...
func (m *mockAccountRepoForGemini) SetBanned(ctx context.Context, id int64, errorMsg string) error {
	return nil
}
...
func (m *mockGroupRepoForGemini) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, status, search string, isExclusive *bool, _ string) ([]Group, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
