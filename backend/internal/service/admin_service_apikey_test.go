...
func (s *groupRepoStubForGroupUpdate) ListWithFilters(context.Context, pagination.PaginationParams, string, string, string, *bool, string) ([]Group, *pagination.PaginationResult, error) {
	panic("unexpected")
}
