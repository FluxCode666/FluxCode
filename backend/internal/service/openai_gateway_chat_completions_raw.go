...
// openaiCCRawAllowedHeaders 是 Chat Completions 直连路径的客户端请求头白名单。
// Codex 专用请求头仅适用于 ChatGPT OAuth 上游，透传到第三方兼容上游可能导致 400。
// Content-Type、Authorization 与 Accept 由直连请求显式设置。
