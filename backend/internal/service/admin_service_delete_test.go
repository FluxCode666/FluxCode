...
func (s *userRepoStub) UpdateReferralCode(ctx context.Context, userID int64, code string) error {
	panic("unexpected UpdateReferralCode call")
}

func (s *userRepoStub) UpdateReferredBy(ctx context.Context, userID int64, referrerID int64) error {
	panic("unexpected UpdateReferredBy call")
}

func (s *userRepoStub) IsFirstRecharge(ctx context.Context, userID int64) (bool, error) {
	panic("unexpected IsFirstRecharge call")
}

func (s *userRepoStub) ListActiveUserIDs(ctx context.Context) ([]int64, error) {
	panic("unexpected ListActiveUserIDs call")
}
...
func (s *groupRepoStub) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, status, search string, isExclusive *bool, _ string) ([]Group, *pagination.PaginationResult, error) {
	panic("unexpected ListWithFilters call")
}
...
func (s *proxyRepoStub) ListAll(ctx context.Context) ([]Proxy, error) {
	panic("unexpected ListAll call")
}

func (s *proxyRepoStub) ListAllWithAccountCount(ctx context.Context) ([]ProxyWithAccountCount, error) {
	panic("unexpected ListAllWithAccountCount call")
}
...
func (s *redeemRepoStub) Use(ctx context.Context, id, userID int64, subscriptionMode *string) error {
