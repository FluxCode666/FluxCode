...
type GroupRepository interface {
	...
	ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, status, search string, isExclusive *bool, subscriptionType string) ([]Group, *pagination.PaginationResult, error)
