...
// openAIResponsesRejectedFieldRetryState bounds compatibility retries and
// prevents a malformed upstream error from replaying an identical payload.
...
// normalizeOpenAIResponsesRejectedFieldRetryBody removes only an explicitly
// rejected compatibility field. It never retries generic 400 responses.
