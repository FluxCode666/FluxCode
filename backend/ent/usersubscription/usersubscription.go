...
const (
	...
	GrantsTable = "subscription_grants"
	// GrantsInverseTable is the table name for the SubscriptionGrant entity.
	// It exists in this package in order to avoid circular dependency with the "subscriptiongrant" package.
	GrantsInverseTable = "subscription_grants"
	// GrantsColumn is the table column denoting the grants relation/edge.
	GrantsColumn = "subscription_id"
