...
func (_q *ProviderProfileQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ProviderProfileQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *ProviderProfileQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ProviderProfileQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *ProviderProfileQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *ProviderProfileQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ProviderProfileQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(providerprofile.Table, providerprofile.Columns, sqlgraph.NewFieldSpec(providerprofile.FieldID, field.TypeInt64))
	_spec.From = _q.sql
...
func (_q *ProviderProfileQuery) ForUpdate(opts ...sql.LockOption) *ProviderProfileQuery {
...
func (_q *ProviderProfileQuery) ForShare(opts ...sql.LockOption) *ProviderProfileQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
