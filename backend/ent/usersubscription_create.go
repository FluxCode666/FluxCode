...
func (_c *UserSubscriptionCreate) AddGrantIDs(ids ...int64) *UserSubscriptionCreate {
	_c.mutation.AddGrantIDs(ids...)
	return _c
}

// AddGrants adds the "grants" edges to the SubscriptionGrant entity.
func (_c *UserSubscriptionCreate) AddGrants(v ...*SubscriptionGrant) *UserSubscriptionCreate {
