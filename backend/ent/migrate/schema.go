...
var (
	...
	MediaArtifactsColumns = []*schema.Column{
		...
		{Name: "position", Type: field.TypeInt, Default: 0, SchemaType: map[string]string{"postgres": "integer"}},
		...
		{Name: "width", Type: field.TypeInt, Nullable: true, SchemaType: map[string]string{"postgres": "integer"}},
		{Name: "height", Type: field.TypeInt, Nullable: true, SchemaType: map[string]string{"postgres": "integer"}},
	...
	MediaTasksColumns = []*schema.Column{
		...
		{Name: "progress", Type: field.TypeInt, Default: 0, SchemaType: map[string]string{"postgres": "integer"}},
		...
		{Name: "upstream_task_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
