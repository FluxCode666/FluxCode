...
var (
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "legal_terms_accepted", Type: field.TypeBool, Default: false},
		{Name: "legal_terms_version", Type: field.TypeString, Size: 32, Default: ""},
		{Name: "legal_terms_accepted_at", Type: field.TypeTime, Nullable: true},
