...
type ChannelMonitor struct {
	...
	// OpenAI request protocol: chat_completions or responses
	...
	// ExtraModels holds the value of the "extra_models" field.
	...
	// Per-run scheduling jitter in seconds; actual delay is interval_seconds +/- jitter_seconds, and service validation keeps the effective interval >= 15 seconds
