...
type APIKey struct {
	...
	// API key level system prompt
	SystemPrompt string `json:"system_prompt,omitempty"`
	// API key level system prompt mode
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldKey, apikey.FieldName, apikey.FieldStatus, apikey.FieldSystemPrompt, apikey.FieldSystemPromptMode:
