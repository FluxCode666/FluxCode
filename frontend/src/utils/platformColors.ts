...
export type Platform = 'anthropic' | 'openai' | 'codex2api' | 'antigravity' | 'gemini' | 'media'
...
const BADGE: Record<Platform, string> = {
  ...
  media: 'bg-rose-500/10 text-rose-600 border-rose-500/30 dark:text-rose-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  media: 'bg-rose-500/10 text-rose-600 dark:bg-rose-500/10 dark:text-rose-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  media: 'border-rose-500/20 dark:border-rose-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  media: 'bg-gradient-to-r from-rose-400 to-rose-500',
}
...
const ICON: Record<Platform, string> = {
  ...
  media: 'text-rose-500 dark:text-rose-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  media: 'bg-rose-600 text-white hover:bg-rose-700 active:bg-rose-800 dark:bg-rose-600/80 dark:hover:bg-rose-600',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  media: 'from-rose-500 to-rose-600',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'codex2api' || p === 'antigravity' || p === 'gemini' || p === 'media'
}
...
export function platformLabel(p: string): string {
  switch (p) {
    ...
    case 'codex2api': return 'Codex2api'
