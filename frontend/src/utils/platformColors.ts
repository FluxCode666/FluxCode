...
export type Platform = 'anthropic' | 'openai' | 'codex2api' | 'antigravity' | 'gemini' | 'embedding'
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'codex2api' || p === 'antigravity' || p === 'gemini' || p === 'embedding'
}
