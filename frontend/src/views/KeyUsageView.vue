  ...
  <div class="relative flex min-h-screen flex-col bg-gray-50 dark:bg-dark-950">
    ...
    <PublicFooter :site-name="siteName">
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        class="text-[11px] text-gray-500 transition-colors hover:text-gray-700 dark:text-dark-400 dark:hover:text-white"
      >{{ t('home.docs') }}</a>
      <a
        :href="githubUrl"
        target="_blank"
...
const siteName = computed(() => appStore.cachedPublicSettings?.site_name || appStore.siteName || 'FluxCode')
const siteLogo = computed(() => appStore.cachedPublicSettings?.site_logo || appStore.siteLogo || '')
const docUrl = computed(() => appStore.cachedPublicSettings?.doc_url || appStore.docUrl || '')
const githubUrl = 'https://github.com/FluxCode666/FluxCode'
