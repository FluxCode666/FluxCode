export default {
  ...
  common: {
    ...
    giftBalance: '赠送余额',
    nextExpiry: '最近到期',
    expiryAmountAt: '${amount} 将于 {date} 到期',
    noExpiry: '无即将到期',
    available: '可用',
  ...
  auth: {
    ...
    referralCodeLabel: '推广码',
    referralCodePlaceholder: '输入推广码（可选）',
    referralCodeValid: '推广码有效',
    referralCodeInvalid: '推广码无效',
    referralCodeValidating: '正在验证推广码...',
    referralCodeInvalidCannotRegister: '推广码无效，请检查后重试或清空推广码',
  ...
  referral: {
    ...
    overview: '概览',
    totalInvites: '总邀请数',
    completedInvites: '已完成邀请',
    totalEarned: '累计收益',
    giftBalanceRemaining: '赠送余额',
    inviteList: '我的邀请',
    giftBalanceRecords: '赠送余额记录',
    noInvites: '暂无邀请记录，分享您的推广码开始吧！',
    noGiftRecords: '暂无赠送余额记录。',
    status: '状态',
    pending: '待完成',
    completed: '已完成',
    ...
    neverExpires: '永不过期',
    expired: '已过期',
    sourceReferralInvitee: '注册奖励',
    sourceReferralInviter: '推广奖励（下线首充）',
    sourceReferralOngoing: '持续奖励（下线充值）',
    sourceAdminGrant: '管理员发放',
    giftNote: '备注',
    noReferralCode: '您还没有推广码。',
    referralDisabled: '推广功能当前未启用。',
    disabledTitle: '推广功能未启用',
    disabledDescription: '管理员尚未启用推广功能，请联系管理员了解详情。',
    howItWorks: '如何运作',
    step1: '将您的推广码或链接分享给朋友',
    step2: '朋友使用您的推广码注册',
    step3: '双方均可获得赠送余额奖励',
    generateCodeSuccess: '推广码生成成功！',
    generateCodeFailed: '生成推广码失败',
    loadFailed: '加载推广数据失败',
    trendTitle: '邀请趋势',
    last7Days: '最近 7 天',
    last30Days: '最近 30 天',
  ...
  salesCommissions: {
    ...
    salesUserId: '搜索销售用户',
    refereeUser: '被邀请用户',
    refereeUserId: '搜索被邀请用户',
    paymentOrder: '订单',
    paymentOrderId: '订单 ID',
    allStatuses: '全部状态',
    commissionRate: '比例',
    commissionContext: '佣金上下文',
    ...
    settleMax: '最大可结算',
    settleNote: '备注',
    settleNotePlaceholder: '可选，如：银行转账 / 微信转账等',
    settleConfirm: '确认结算',
    settleSuccess: '结算成功',
    settleFailed: '结算失败',
    settleErrNoSettleable: '该销售用户当前没有可结算的金额',
    settleErrAmountExceeds: '结算金额超过了可结算余额，请刷新后重试',
    recompute: {
      button: '重算缺失佣金',
      running: '正在重算…',
      tooltip: '扫描已支付的余额充值订单，自动补齐尚未生成的销售佣金记录（幂等，可重复点击）',
      confirmTitle: '确认重算缺失的销售佣金？',
      confirmMessage: '将扫描所有已完成的余额充值订单，对那些"销售推广人下线已充值但销售佣金记录缺失"的订单自动补写记录。该操作幂等，重复执行不会重复发放佣金。是否继续？',
      confirmButton: '开始重算',
      resultSummary: '重算完成：扫描 {scanned} / 处理 {processed} / 失败 {failed}',
      noMissing: '没有发现缺失的销售佣金记录，所有订单均已补齐',
      failed: '重算失败，请稍后重试或查看后端日志'
    },
  ...
  adminReferral: {
    ...
    tabLeaderboard: '排行榜',
    tabGrant: '发放赠送余额',
    referralEnabled: '启用普通用户推广功能',
    inviteeReward: '被邀请人奖励 ($)',
    inviterReward: '邀请人奖励 ($)',
    inviterRewardType: '邀请人奖励类型',
    fixedAmount: '固定金额',
    percentageOfFirstRecharge: '首充金额百分比',
    giftBalanceExpiry: '赠送余额有效期（天，0 = 永不过期）',
    maxInvites: '最大邀请数（0 = 不限制）',
    ongoingRewardEnabled: '启用推广人持续奖励',
    firstChargeSection: '首充奖励配置',
    inviterFirstChargeRewardEnabled: '启用邀请人首充奖励',
    inviterFirstChargeRewardType: '邀请人首充奖励类型',
    inviterFirstChargeRewardValue: '邀请人首充奖励金额',
    inviteeFirstChargeRewardEnabled: '启用被邀请人首充奖励',
    inviteeFirstChargeRewardType: '被邀请人首充奖励类型',
    inviteeFirstChargeRewardValue: '被邀请人首充奖励金额',
    ongoingRewardValue: '推广人持续奖励金额',
    ongoingRewardType: '推广人持续奖励类型',
    percentage: '百分比',
    ongoingRewardMaxCount: '推广人持续奖励最大次数（0 = 不限制）',
    ongoingRewardDurationDays: '推广人持续奖励有效期（天，0 = 永久）',
    inviteeOngoingRewardEnabled: '启用被邀请人持续奖励',
    inviteeOngoingRewardType: '被邀请人持续奖励类型',
    inviteeOngoingRewardValue: '被邀请人持续奖励金额',
    inviteeOngoingRewardMaxCount: '被邀请人持续奖励最大次数（0 = 不限制）',
    inviteeOngoingRewardDurationDays: '被邀请人持续奖励有效期（天，0 = 永久）',
    saving: '保存中...',
    saveConfig: '保存配置',
    noReferrals: '暂无推广记录。',
    date: '日期',
    ...
    expiryDays: '有效期（天，0 = 永不过期）',
    notes: '备注（可选）',
    notesPlaceholder: '可选备注',
    granting: '发放中...',
    grantGiftBalance: '发放赠送余额',
    grantGiftBalanceHint: '发放余额为赠送余额，仅用于兜底操作，也会新增审计日志。',
    loadFailed: '加载数据失败',
    configSaved: '配置保存成功',
    configSaveFailed: '保存配置失败',
    grantSuccess: '赠送余额发放成功',
    grantFailed: '发放赠送余额失败',
    tabDashboard: '数据看板',
    tabUserConfig: '用户配置',
    conversionFunnel: '转化漏斗',
    funnelRegistrations: '邀请注册',
    funnelFirstRecharges: '已首充',
    conversionRate: '注册→首充转化率',
    trendTitle: '推广趋势',
    trendInvitations: '新增邀请',
    trendCompletions: '完成转化',
    noTrendData: '暂无趋势数据',
    filterReferrerPlaceholder: '搜索推广人邮箱',
    filterRefereePlaceholder: '搜索被邀请人邮箱',
    customDate: '自定义日期',
    allStatus: '全部状态',
    allTime: '全部时间',
    thisMonth: '本月',
    ...
    batchUserIdsPlaceholder: '每行一个 ID 或用逗号分隔',
    batchUserIdsEmpty: '请输入至少一个用户 ID',
    batchConfirm: '确认要批量发放吗？此操作不可撤销。',
    grantBatchAction: '批量发放',
    batchSuccess: '已成功发放给 {count} 个用户',
    userConfigTitle: '用户级配置覆盖',
    userConfigDescription: '为指定用户设置个性化推广配置（覆盖全局配置）。留空字段表示使用全局值。',
    load: '加载',
    userHasCustom: '该用户已有自定义配置',
    userNoCustom: '该用户暂无自定义配置',
    clearOverride: '清除自定义',
    clearOverrideConfirm: '确定要清除该用户的自定义配置吗？将恢复使用全局配置。',
    clearOverrideSuccess: '已清除自定义配置',
    clearOverrideFailed: '清除失败',
    actions: '操作',
    manualComplete: '手动完成',
    manualCompletePrompt: '请输入手动完成原因。该操作仅补发推广侧奖励，不补发充值本体或订阅本体。',
    manualCompletePayAmountPrompt: '请输入本次手动完成对应的原始支付金额（CNY）。',
    manualCompleteCreditedAmountPrompt: '请输入本次手动完成对应的到账额度。',
    manualCompleteSuccess: '推广记录已手动完成',
    manualCompleteFailed: '手动完成失败',
    manualCompleteNotesRequired: '请输入手动完成备注',
    manualCompleteAmountsRequired: '请输入有效的支付金额和到账额度',
    useGlobal: '使用全局值',
    saveUserConfig: '保存用户配置',
    userConfigSaved: '用户配置已保存',
    userConfigSaveFailed: '保存用户配置失败',
    userConfigLoadFailed: '加载用户配置失败',
    regularReferralSection: '普通用户推广',
    inviteeRewardEnabled: '启用被邀请人注册奖励',
    salesReferralSection: '销售用户推广',
    salesReferralEnabled: '启用销售推广',
    salesInviteeRewardEnabled: '启用被邀请人注册奖励（销售推广）',
    salesInviteeReward: '被邀请人注册奖励 ($)（销售推广）',
    salesInviteeFirstChargeRewardEnabled: '启用被邀请人首充奖励（销售推广）',
    salesInviteeFirstChargeRewardType: '被邀请人首充奖励类型（销售推广）',
    salesInviteeFirstChargeRewardValue: '被邀请人首充奖励金额（销售推广）',
    salesInviteeOngoingRewardEnabled: '启用被邀请人持续充值奖励（销售推广）',
    salesInviteeOngoingRewardType: '持续奖励类型（销售推广）',
    salesInviteeOngoingRewardValue: '持续奖励金额（销售推广）',
    salesInviteeOngoingRewardMaxCount: '持续奖励最大次数（0 = 不限制）（销售推广）',
    salesInviteeOngoingRewardDurationDays: '持续奖励有效天数（0 = 永久）（销售推广）',
    offlineRecharge: {
      button: '录入私账充值',
      title: '录入私账充值',
      description: '为走私账充值的用户录入充值记录，系统将自动查出推广关系并触发推广奖励（普通推广→赠送余额，销售推广→佣金记录）。',
      userEmail: '充值用户',
      userEmailPlaceholder: '输入邮箱搜索用户',
      selectedUser: '已选择用户',
      payAmount: '实付金额',
      creditedAmount: '到账金额（余额增加量）',
      creditBalance: '同时给用户增加账户余额',
      note: '备注',
      notePlaceholder: '如：微信转账 / 支付宝转账',
      submit: '确认录入',
      success: '录入成功，推广人: {referrer}（{type}），奖励已触发',
      failed: '录入失败',
      errNoReferral: '该用户没有推广关系，无法触发推广奖励',
      salesReferrer: '销售推广',
      normalReferrer: '普通推广',
    },
  },
  ...
  admin: {
    ...
    dashboard: {
      ...
      tokenUsageTrend: 'Token 使用趋势',
      requestCountTrend: '请求数统计',
      subscriptionExhaustionTrend: '订阅用满趋势',
      totalSubscriptions: '总子订阅数',
      exhaustedSubscriptions: '已用满子订阅数',
      exhaustionRate: '用满率',
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 fluxcode-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    users: {
      ...
      sales: {
        title: '销售佣金配置',
        hint: '启用后可按固定比例或按月累计梯度计算邀请充值佣金。',
        isSales: '销售人员',
        salesUser: '销售',
        nonSales: '非销售',
        allSalesStatus: '全部销售状态',
        salesOnly: '仅销售',
        nonSalesOnly: '仅非销售',
        mode: '提成模式',
        modeFixed: '固定比例',
        modeTiered: '梯度提成',
        commissionRate: '提成比例（%）',
        minMonthlySales: '最低月销售额（CNY）',
        fixedSummary: '固定 {rate}',
        tieredSummary: '{count} 档阶梯',
        minMonthlySalesCompact: '门槛 {amount}/月',
        tiers: '梯度规则',
        tierHint: '留空“销售额上限”表示该梯度没有封顶，且必须作为最后一档。',
        addTier: '添加梯度',
        noTiers: '还没有梯度规则',
        tierLabel: '梯度 {index}',
        tierFrom: '销售额下限（CNY）',
        tierTo: '销售额上限（CNY）',
        tierToPlaceholder: '留空表示无上限',
        tierRate: '提成比例（%）',
        invalidRate: '销售提成比例必须大于 0 且不超过 100',
        invalidMinMonthlySales: '最低月销售额必须大于或等于 0',
        tiersRequired: '梯度提成至少需要配置一条梯度规则',
        invalidTierFrom: '第 {index} 条梯度的销售额下限必须大于或等于 0',
      ...
      withdrawAmount: '退款金额',
      withdrawAll: '全部',
      createOrderAndAudit: '同时创建订单记录和审计日志',
      ...
      auditLogs: '审计日志',
      auditLogsTip: '点击查看审计日志',
      auditLogsTitle: '用户订单审计日志',
      noAuditLogs: '暂无审计日志',
      auditOrderId: '订单ID',
      auditOrderType: '订单类型',
      auditPaymentType: '支付方式',
      auditAmount: '到账金额',
      auditPayAmount: '实付金额',
      auditStatus: '状态',
      auditAction: '操作',
      ...
      auditOperator: '操作人',
      auditTime: '时间',
      failedToLoadAuditLogs: '加载审计日志失败',
      giftBalance: '赠送余额',
      giftRemaining: '剩余',
      giftExpiresAt: '到期时间',
      giftSource: {
        referral_invitee: '被邀请人注册奖励',
        referral_inviter: '邀请人奖励',
        referral_ongoing: '持续充值奖励',
        referral_invitee_first_charge: '被邀请人首充奖励',
        admin_grant: '管理员发放',
      },
      createdAt: '创建时间',
      totalRecharged: '总充值',
    ...
    groups: {
      ...
      mediaModelsLoadFailed: '媒体模型列表加载失败；为避免误删，本次不会判断或清理历史授权。',
      manageMediaModels: '前往媒体模型注册表',
      mediaModelsSelected: '已授权 {count} 个媒体模型',
      unavailableMediaModelsHint: '以下历史授权对应的模型当前未就绪，可从分组中安全移除。',
      removeUnavailableMediaModel: '移除授权',
      unavailableMediaModelsSelected: '另有 {count} 个历史失效授权',
    ...
    accounts: {
      ...
      mediaConfig: {
        title: '媒体供应商与模型绑定',
        description: '配置该媒体账号提供的规范模型及其上游模型。Adapter 由系统按模型厂商和规范模型解析，无需在账号中填写。',
        provider: '上游供应商',
        providerPlaceholder: '例如 volcengine、xai、google',
        providerHint: '标识该账号所属的上游服务商；它不参与 Adapter 解析。',
        ...
        registryModelHint: '系统 Adapter：{adapter}（{match}）；同步：{sync}，原生异步：{native}，内容回源：{content}',
        legacyModelUnavailable: '该历史模型当前未启用或 Adapter 未就绪；启用此绑定时无法保存。请禁用或移除。',
        modeCapabilityMismatch: '所选上游执行方式超出系统 Adapter 的实际能力。',
      ...
      rebuildSchedulerCache: '重建调度缓存',
      rebuildSchedulerCacheRunning: '重建中...',
      rebuildSchedulerCacheSuccess: '调度缓存重建完成',
      ...
      types: {
        ...
        soraApiKeyHint: '连接另一个 FluxCode 或兼容 API',
        soraBaseUrlRequired: 'Sora apikey 账号必须设置上游地址（Base URL）',
        soraBaseUrlInvalidScheme: 'Base URL 必须以 http:// 或 https:// 开头',
        upstream: '对接上游',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 FluxCode 实例的场景。',
      ...
      openaiImagePromptLabel: '生图提示词',
      openaiImagePromptPlaceholder: '例如：生成一只戴宇航员头盔的橘猫，像素插画风格，纯色背景。',
      openaiImagePromptDefault: 'Generate a clean product-style OpenAI image test on a simple background.',
      openaiImageTestHint: '选择 OpenAI 图片模型后，这里会直接发起生图测试，并在下方展示返回图片。',
      openaiImageTestMode: '模式：OpenAI 生图测试',
      openaiImagePreview: '生成结果：',
      openaiImageReceived: '已收到第 {count} 张测试图片',
      soraUpstreamBaseUrlHint: '上游 Sora 服务地址（另一个 FluxCode 实例或兼容 API）',
    ...
    // Promotions (充值 & 订阅促销活动)
    promotions: {
      title: '促销活动管理',
      description: '创建和管理充值/订阅促销活动',
      create: '创建活动',
      edit: '编辑活动',
      deleteTitle: '删除活动',
      ...
      // 表单
      name: '活动名称',
      namePlaceholder: '如：夏季充值优惠',
      descriptionLabel: '描述',
      descriptionPlaceholder: '活动描述',
      promotionType: '活动类型',
      discountMode: '折扣方式',
      reducePay: '减少支付',
      bonusCredit: '额外赠送',
      ...
      rechargeRate: '支付比例',
      rechargeRateHint: '0.8 = 只需支付 80%',
      rechargeBonusRate: '赠送比例',
      rechargeBonusRateHint: '0.2 = 额外赠送 20%',
      // 订阅计划规则
      planRules: '计划折扣规则',
      addPlanRule: '添加规则',
      noPlanRules: '暂无计划规则，点击"添加规则"创建。',
      planRulesCount: '条规则',
      plan: '计划',
      selectPlan: '选择计划',
      discountByRate: '按比例',
      discountByAmount: '固定金额',
      discountRate: '折扣比例',
      discountRateHint: '0.8 = 原价的 80%',
      discountAmount: '折扣金额',
      minPriceFloor: '最低价格保护',
      // 通用
      ...
      enabled: '活动已启用',
      disabled: '活动已禁用',
      deleteConfirm: '确定要删除此促销活动吗？此操作无法撤销。',
      failedToLoad: '加载活动失败',
      failedToSave: '保存活动失败',
    ...
    settings: {
      ...
      mediaGeneration: {
        title: '媒体生成运行时',
        description: '配置同步等待、超时处理与视频交付回退行为。',
        syncWaitTimeout: '同步等待超时（秒）',
        syncWaitTimeoutHint: '设置媒体生成同步请求的应用级计时器；设为 0 可关闭此计时器。',
        timeoutDisabledWarning: '0 表示不启用应用级计时器。此设置本身不保证请求会自动转为异步；是否启用异步回退由下方开关独立决定。',
        fallbackAsync: '超时后启用异步回退',
        fallbackAsyncHint: '同步等待超时且请求已提交上游时，允许运行时按实际能力回退为异步处理。',
        timeoutBillingPolicy: '超时计费策略',
        timeoutBillingPolicyHint: '仅适用于“同步等待超时且已提交上游”的请求；不适用于队列、Worker 或存储错误。',
        penalty: '按惩罚比例扣费',
        refund: '全额退款',
        penaltyRatio: '惩罚扣费比例',
        penaltyRatioHint: '仅对“同步等待超时且已提交上游”的请求按此百分比扣费，范围为 0%–100%。',
        videoStorageMode: '视频存储模式',
        hybrid: '混合存储',
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 FluxCode 用户登录',
      ...
      payment: {
        ...
        modeWap: '手机网站支付',
        modeAuto: '自动',
        modeAlipayQRCodeHint: '当面付（推荐）：所有设备始终生成二维码，手机用户可长按保存或换设备扫码。仅需开通"当面付"产品。',
        modeAlipayWapHint: '手机网站支付：所有设备直接跳转到支付宝。仅在已开通"手机网站支付"产品时使用，否则手机端会跳到错误页。',
        modeAlipayAutoHint: '自动：手机端走手机网站支付（跳转），桌面端走当面付（二维码）。仅在同时开通了两个产品时使用。',
        ...
        field_secretKey: '密钥',
        configRepairRequired: '当前配置无法解密，请重新填写完整配置后保存',
        ...
        orderIdPrefix: '订单号前缀',
        orderIdPrefixHint: '用于支付渠道订单号，仅影响新订单。支持字母、数字、下划线、短横线，最多 16 位',
        orderIdPreview: '订单号预览',
        preview: '预览',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 FluxCode',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 FluxCode AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    qr: {
      ...
      alipayAlertTitle: '请使用支付宝扫码',
      wxpayAlertTitle: '请使用微信扫码',
    ...
    rechargeAmountMinHint: '单次充值下限：{min}',
    rechargeAmountMaxHint: '单次充值上限：{max}',
    rechargeAmountRangeHint: '充值范围：{min} - {max}',
    amountBelowRechargeMin: '当前输入 {amount}，低于单次充值下限 {min}',
    amountExceedsRechargeMax: '当前输入 {amount}，已超过单次充值上限 {max}',
    methodAmountTooLow: '当前支付方式单次最低支持 {min}',
    methodAmountTooHigh: '当前支付方式单次最高支持 {max}',
    ...
    promoActualPay: '实际支付',
    usePromotion: '使用促销活动',
    selectPromotion: '促销活动（可选）',
    promoModeDiscount: '立减',
    promoModeBonus: '充送',
    promoRemaining: '剩余 {n} 次',
    refundReason: '退款原因',
