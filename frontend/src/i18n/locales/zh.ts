export default {
  ...
  referral: {
    ...
    sourceReferralInviter: '推广奖励',
    sourceReferralOngoing: '持续奖励',
  ...
  adminReferral: {
    ...
    ongoingRewardEnabled: '启用持续奖励',
    ongoingRewardValue: '持续奖励金额',
    ongoingRewardType: '持续奖励类型',
    percentage: '百分比',
    ongoingRewardMaxCount: '持续奖励最大次数（0 = 不限制）',
    saving: '保存中...',
    saveConfig: '保存配置',
    noReferrals: '暂无推广记录。',
    date: '日期',
    ...
    ongoingRewardDurationDays: '持续奖励有效天数（0 = 永久）',
