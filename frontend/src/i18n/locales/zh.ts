    ...
    accounts: {
      ...
      openai: {
        ...
        forceChatCompletionsDesc:
          '仅对 OpenAI API Key 生效。开启后请求上游 /v1/chat/completions；关闭后请求上游 /v1/responses。能力探测结果仅作提示，不会自动切换协议。',
        ...
        codexFingerprintMode: 'Codex 设备指纹收敛',
        codexFingerprintModeDesc: '仅对 OpenAI OAuth 生效。将 Codex 设备/会话标识按账号收敛，减少上游可见的设备和会话数。默认使用 session。',
        codexFingerprintOff: '关闭（off）',
        codexFingerprintDevice: '仅设备（device）',
        codexFingerprintSession: '设备+会话（session，默认）',
        codexFingerprintFull: '全部（full）',
      ...
      embedding: {
        baseUrlHint: '填写公网或私网 HTTP/HTTPS 的 OpenAI-compatible embedding 地址',
      ...
      poolModeRetryStatusCodesHint: '仅在池模式下生效。输入以逗号或空格分隔的 HTTP 状态码，默认 {default}。',
