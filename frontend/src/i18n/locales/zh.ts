export default {
  ...
  admin: {
    ...
    growth: {
      title: '运营大盘',
      description: '用户增长、留存、付费转化和产品使用的增长运营中心',
      timezoneLabel: '统计时区',
      ...
      userGrowth: '用户增长',
      retention: '留存分析',
      paymentConversion: '充值转化',
      featureUsage: '功能使用',
      audienceProfile: '用户画像',
      totalUsers: '总用户数',
      dau: 'DAU',
      mau: 'MAU',
      todayNewUsers: '今日新增',
      todayPaidUsers: '今日付费用户',
      monthRevenue: '本月收入',
      arpu: 'ARPU',
      paymentConversionRate: '付费转化率',
      repurchaseRate: '复购率',
      userTrend: '新增用户趋势',
      sources: '渠道来源',
      sourcePaymentRates: '渠道付费率',
      ...
      noData: '暂无数据',
      notAvailable: '未接入',
      trackingNotReady: '完整前端行为埋点未接入',
      averageTurns: '平均对话轮数',
      averageSessionDuration: '平均会话时长',
      averageInputTokens: '平均输入 Token',
      averageOutputTokens: '平均输出 Token',
      failedToLoad: '加载运营大盘失败'
    },
