export default {
  ...
  admin: {
    ...
    growth: {
      ...
      description: 'Growth operations center for users, retention, payment conversion, and product usage',
      timezoneLabel: 'Reporting timezone',
      ...
      todayPaidUsers: 'Paid Today',
      monthRevenue: 'Monthly Revenue',
      arpu: 'ARPU',
      paymentConversionRate: 'Payment Rate',
      repurchaseRate: 'Repurchase Rate',
      userTrend: 'New User Trend',
      sources: 'Acquisition Sources',
      sourcePaymentRates: 'Source Payment Rates',
      retentionMatrix: 'Retention Matrix',
      retentionTrend: 'Retention Trend',
      paymentFunnel: 'Payment Funnel',
      paymentPlans: 'Plan Analysis',
      firstPayment: 'First Payment',
      featureRanking: 'Feature Ranking',
      sessionMetrics: 'Session Metrics',
      deviceProfile: 'Device Distribution',
      osProfile: 'OS Distribution',
      browserProfile: 'Browser Distribution',
      clientProfile: 'Client Distribution',
      newRegistered: 'New Registered',
      newActivated: 'New Activated',
      newPaid: 'New Paid',
      ...
      trackingNotReady: 'Full frontend behavior tracking is not connected yet',
      averageTurns: 'Avg Turns',
      averageSessionDuration: 'Avg Session Duration',
      averageInputTokens: 'Avg Input Tokens',
      averageOutputTokens: 'Avg Output Tokens',
      failedToLoad: 'Failed to load growth dashboard'
    },
