export default {
  ...
  // Setup Wizard
  setup: {
    title: 'FluxCode Setup',
    description: 'Configure your FluxCode instance',
    database: {
  ...
  common: {
    ...
    expiryAmountAt: '${amount} expires on {date}',
    noExpiry: 'No upcoming expiry',
    available: 'Available',
  ...
  auth: {
    ...
    referralCodeValidating: 'Validating referral code...',
    referralCodeInvalidCannotRegister: 'Invalid referral code. Please check and try again or clear the referral code field',
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      quickSetup: {
        title: 'Quick Setup Command',
        description: 'Copy and paste the following command into your terminal to configure everything at once.',
        copy: 'Copy Command',
        copied: 'Copied!',
      },
    },
  ...
  referral: {
    ...
    giftBalanceRemaining: 'Gift Balance',
    inviteList: 'My Invites',
    giftBalanceRecords: 'Gift Balance Records',
    noInvites: 'No invites yet. Share your referral code to get started!',
    noGiftRecords: 'No gift balance records yet.',
    status: 'Status',
    pending: 'Pending',
    completed: 'Completed',
    ...
    neverExpires: 'Never',
    expired: 'Expired',
    sourceReferralInvitee: 'Registration Bonus',
    sourceReferralInviter: 'Referral Reward (Invitee First Recharge)',
    sourceReferralOngoing: 'Ongoing Reward (Invitee Recharge)',
    sourceAdminGrant: 'Admin Grant',
    giftNote: 'Note',
    noReferralCode: 'You don\'t have a referral code yet.',
    referralDisabled: 'Referral feature is currently disabled.',
    disabledTitle: 'Referral Feature Disabled',
    disabledDescription: 'The administrator has not enabled the referral feature. Please contact support for details.',
    howItWorks: 'How It Works',
    step1: 'Share your referral code or link with friends',
    step2: 'They register using your code',
    step3: 'Both of you receive bonus balance rewards',
    generateCodeSuccess: 'Referral code generated successfully!',
    generateCodeFailed: 'Failed to generate referral code',
    loadFailed: 'Failed to load referral data',
    trendTitle: 'Invitation Trend',
    last7Days: 'Last 7 days',
  ...
  salesCommissions: {
    ...
    salesUserId: 'Search sales user',
    refereeUser: 'Invited User',
    refereeUserId: 'Search invited user',
    paymentOrder: 'Order',
    paymentOrderId: 'Order ID',
    allStatuses: 'All Status',
    commissionRate: 'Rate',
    commissionContext: 'Commission Context',
    ...
    actions: 'Actions',
    settle: 'Settle',
    settleTitle: 'Create Settlement',
    settleFor: 'Settle for',
    settleAmount: 'Settlement Amount',
    settleMax: 'Max settleable',
    settleNote: 'Note',
    settleNotePlaceholder: 'Optional, e.g. bank transfer / WeChat transfer',
    settleConfirm: 'Confirm Settlement',
    settleSuccess: 'Settlement created successfully',
    settleFailed: 'Settlement failed',
    settleErrNoSettleable: 'This sales user has no settleable amount at the moment',
    settleErrAmountExceeds: 'Settlement amount exceeds the available settleable balance, please refresh and try again',
    recompute: {
      button: 'Recompute missing commissions',
      running: 'Recomputing…',
      tooltip: 'Scan completed balance recharge orders and backfill any missing sales commission records (idempotent, safe to click multiple times)',
      confirmTitle: 'Recompute missing sales commissions?',
      confirmMessage: 'This will scan all completed balance recharge orders and backfill commission records for orders whose referee has paid but no sales commission record was created. The operation is idempotent—repeated runs will not duplicate commissions. Continue?',
      confirmButton: 'Start recompute',
      resultSummary: 'Recompute done: scanned {scanned} / processed {processed} / failed {failed}',
      noMissing: 'No missing sales commission records found—everything is already in sync',
      failed: 'Recompute failed; please retry later or check the backend logs'
    },
    ...
    monthlyProgress: {
      ...
      monthlySales: 'Monthly Sales',
      monthlyCommission: 'Commission Earned',
      threshold: 'Threshold',
      thresholdMet: 'Threshold met',
      thresholdNotMet: 'Threshold not met',
      toThreshold: '¥{amount} more to reach threshold',
      currentTier: 'Current Tier',
      nextTier: 'Next Tier',
      tierRange: '¥{from} ~ ¥{to}',
      tierRangeOpen: '¥{from} and above',
      tierRate: '{rate}%',
      toNextTier: '¥{amount} more to reach the next tier ({rate}%)',
      atTopTier: 'You are at the top tier',
      noTierConfigured: 'No tiered commission configured for this account',
      fixedRateMode: 'Fixed Rate',
      fixedRateText: 'Current rate {rate}% (no tiers)',
      fixedNoThreshold: 'Each qualifying sale earns {rate}% this month',
      previewBadge: 'Preview rules (no events this month yet)',
      frozenBadge: 'Rules frozen for this month',
      ruleEditedHint: 'Admin changes only take effect next month; the current month settles by the frozen snapshot (spec §8.4).',
      tiersTitle: 'Tier Bands',
      tierCurrent: 'Current',
      tierAchieved: 'Crossed',
      tierUpcoming: 'Upcoming'
    },
    statuses: {
      frozen: 'Frozen',
      partial_unlocked: 'Partially Unlocked',
      unlocked: 'Unlocked',
      settled: 'Settled',
  ...
  adminReferral: {
    ...
    completed: 'Completed',
    totalIssued: 'Gift Balance Issued',
    remaining: 'Gift Balance Remaining',
    consumed: 'Consumed',
    tabConfig: 'Configuration',
    tabList: 'Referral List',
    tabLeaderboard: 'Leaderboard',
    tabGrant: 'Grant Gift Balance',
    referralEnabled: 'Enable Regular User Referral',
    inviteeReward: 'Invitee Reward ($)',
    inviterReward: 'Inviter Reward ($)',
    inviterRewardType: 'Inviter Reward Type',
    fixedAmount: 'Fixed Amount',
    percentageOfFirstRecharge: 'Percentage of First Recharge',
    giftBalanceExpiry: 'Gift Balance Expiry (days, 0 = never)',
    maxInvites: 'Max Invites (0 = unlimited)',
    firstChargeSection: 'First Charge Reward',
    inviterFirstChargeRewardEnabled: 'Inviter First Charge Reward Enabled',
    inviterFirstChargeRewardType: 'Inviter First Charge Reward Type',
    inviterFirstChargeRewardValue: 'Inviter First Charge Reward Value',
    inviteeFirstChargeRewardEnabled: 'Invitee First Charge Reward Enabled',
    inviteeFirstChargeRewardType: 'Invitee First Charge Reward Type',
    inviteeFirstChargeRewardValue: 'Invitee First Charge Reward Value',
    ongoingRewardEnabled: 'Inviter Ongoing Reward Enabled',
    ongoingRewardValue: 'Inviter Ongoing Reward Value',
    ongoingRewardType: 'Inviter Ongoing Reward Type',
    percentage: 'Percentage',
    ongoingRewardMaxCount: 'Inviter Ongoing Reward Max Count (0 = unlimited)',
    ongoingRewardDurationDays: 'Inviter Ongoing Reward Duration (days, 0 = forever)',
    inviteeOngoingRewardEnabled: 'Invitee Ongoing Reward Enabled',
    inviteeOngoingRewardType: 'Invitee Ongoing Reward Type',
    inviteeOngoingRewardValue: 'Invitee Ongoing Reward Value',
    inviteeOngoingRewardMaxCount: 'Invitee Ongoing Reward Max Count (0 = unlimited)',
    inviteeOngoingRewardDurationDays: 'Invitee Ongoing Reward Duration (days, 0 = forever)',
    saving: 'Saving...',
    ...
    referee: 'Referee',
    status: 'Status',
    inviteeAmount: 'Invitee $',
    inviterAmount: 'Inviter $',
    ...
    expiryDays: 'Expiry Days (0 = never expire)',
    notes: 'Notes (optional)',
    notesPlaceholder: 'Optional notes',
    granting: 'Granting...',
    grantGiftBalance: 'Grant Gift Balance',
    grantGiftBalanceHint: 'Granted balance is gift balance only, intended for fallback operations and will also create an audit log.',
    loadFailed: 'Failed to load data',
    configSaved: 'Configuration saved successfully',
    configSaveFailed: 'Failed to save configuration',
    grantSuccess: 'Gift balance granted successfully',
    grantFailed: 'Failed to grant gift balance',
    tabDashboard: 'Dashboard',
    tabUserConfig: 'User Config',
    conversionFunnel: 'Conversion Funnel',
    funnelRegistrations: 'Invited Registrations',
    funnelFirstRecharges: 'First Recharges',
    conversionRate: 'Registration → First Recharge Rate',
    trendTitle: 'Referral Trend',
    trendInvitations: 'New Invitations',
    trendCompletions: 'Completions',
    noTrendData: 'No trend data',
    filterReferrerPlaceholder: 'Search referrer email',
    filterRefereePlaceholder: 'Search referee email',
    ...
    grantSingle: 'Single Grant',
    grantBatch: 'Batch Grant',
    batchTarget: 'Target',
    batchAll: 'All Active Users',
    batchSelected: 'Selected Users',
    batchUserIds: 'User ID List',
    batchUserIdsPlaceholder: 'One ID per line, or comma separated',
    batchUserIdsEmpty: 'Please enter at least one user ID',
    batchConfirm: 'Confirm batch grant? This action cannot be undone.',
    grantBatchAction: 'Grant Batch',
    batchSuccess: 'Successfully granted to {count} users',
    userConfigTitle: 'Per-user Configuration Override',
    userConfigDescription: 'Set custom referral configuration for a specific user (overrides global settings). Empty fields use global values.',
    load: 'Load',
    userHasCustom: 'User has custom configuration',
    userNoCustom: 'User has no custom configuration',
    clearOverride: 'Clear Override',
    clearOverrideConfirm: 'Are you sure to clear custom configuration? Will fall back to global settings.',
    clearOverrideSuccess: 'Custom configuration cleared',
    clearOverrideFailed: 'Failed to clear',
    actions: 'Actions',
    manualComplete: 'Mark Completed',
    manualCompletePrompt: 'Enter the manual completion reason. This only grants referral-side rewards and does not credit the recharge or subscription body.',
    manualCompletePayAmountPrompt: 'Enter the original recharge payment amount (CNY) for this manual completion.',
    manualCompleteCreditedAmountPrompt: 'Enter the credited balance amount for this manual completion.',
    manualCompleteSuccess: 'Referral marked as completed',
    manualCompleteFailed: 'Failed to mark referral as completed',
    manualCompleteNotesRequired: 'Please enter completion notes',
    manualCompleteAmountsRequired: 'Please enter valid recharge and credited amounts',
    useGlobal: 'Use Global',
    saveUserConfig: 'Save User Config',
    userConfigSaved: 'User configuration saved',
    userConfigSaveFailed: 'Failed to save user configuration',
    userConfigLoadFailed: 'Failed to load user configuration',
    regularReferralSection: 'Regular User Referral',
    inviteeRewardEnabled: 'Enable Invitee Registration Reward',
    salesReferralSection: 'Sales Referral',
    salesReferralEnabled: 'Enable Sales Referral',
    salesInviteeRewardEnabled: 'Enable Invitee Registration Reward (Sales)',
    salesInviteeReward: 'Invitee Registration Reward ($) (Sales)',
    salesInviteeFirstChargeRewardEnabled: 'Invitee First Charge Reward Enabled (Sales)',
    salesInviteeFirstChargeRewardType: 'Invitee First Charge Reward Type (Sales)',
    salesInviteeFirstChargeRewardValue: 'Invitee First Charge Reward Value (Sales)',
    salesInviteeOngoingRewardEnabled: 'Enable Invitee Ongoing Recharge Reward (Sales)',
    salesInviteeOngoingRewardType: 'Ongoing Reward Type (Sales)',
    salesInviteeOngoingRewardValue: 'Ongoing Reward Value (Sales)',
    salesInviteeOngoingRewardMaxCount: 'Max Ongoing Reward Count (0 = unlimited) (Sales)',
    salesInviteeOngoingRewardDurationDays: 'Ongoing Reward Duration Days (0 = forever) (Sales)',
    offlineRecharge: {
      button: 'Record Offline Recharge',
      title: 'Record Offline Recharge',
      description: 'Record a private/offline recharge for a referred user. The system will automatically find the referral relationship and trigger referral rewards (normal referral → gift balance, sales referral → commission).',
      userEmail: 'Recharged User',
      userEmailPlaceholder: 'Search by email',
      selectedUser: 'Selected user',
      payAmount: 'Pay Amount',
      creditedAmount: 'Credited Amount (balance increase)',
      creditBalance: 'Also credit balance to user account',
      note: 'Note',
      notePlaceholder: 'e.g. WeChat transfer / Alipay transfer',
      submit: 'Confirm',
      success: 'Recorded successfully. Referrer: {referrer} ({type}), rewards triggered',
      failed: 'Record failed',
      errNoReferral: 'This user has no referral relationship, cannot trigger referral rewards',
      salesReferrer: 'Sales',
      normalReferrer: 'Normal',
    },
  },
  ...
  admin: {
    ...
    dashboard: {
      ...
      tokenUsageTrend: 'Token Usage Trend',
      requestCountTrend: 'Request Count Trend',
      subscriptionExhaustionTrend: 'Subscription Exhaustion Trend',
      totalSubscriptions: 'Total Subscriptions',
      exhaustedSubscriptions: 'Exhausted Subscriptions',
      exhaustionRate: 'Exhaustion Rate',
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. fluxcode-backups), choose a region',
    ...
    users: {
      ...
      sales: {
        title: 'Sales commission settings',
        hint: 'Enable fixed-rate or monthly tiered commission for referral recharges.',
        isSales: 'Sales user',
        salesUser: 'Sales',
        nonSales: 'Not sales',
        allSalesStatus: 'All Sales Status',
        salesOnly: 'Sales only',
        nonSalesOnly: 'Non-sales only',
        mode: 'Commission mode',
        modeFixed: 'Fixed rate',
        modeTiered: 'Tiered commission',
        commissionRate: 'Commission rate (%)',
        minMonthlySales: 'Minimum monthly sales (CNY)',
        fixedSummary: 'Fixed {rate}',
        tieredSummary: '{count} tiers',
        minMonthlySalesCompact: 'Min {amount}/month',
        tiers: 'Tier rules',
        tierHint: 'Leave the upper bound empty for an open-ended tier. Open-ended tiers must be last.',
        addTier: 'Add tier',
        noTiers: 'No tier rules yet',
        tierLabel: 'Tier {index}',
        tierFrom: 'Sales from (CNY)',
        tierTo: 'Sales to (CNY)',
        tierToPlaceholder: 'Leave empty for no upper limit',
        tierRate: 'Commission rate (%)',
        invalidRate: 'Sales commission rate must be greater than 0 and at most 100',
        invalidMinMonthlySales: 'Minimum monthly sales must be greater than or equal to 0',
        tiersRequired: 'Tiered commission requires at least one tier rule',
        invalidTierFrom: 'Tier {index} must have a lower bound greater than or equal to 0',
        invalidTierTo: 'Tier {index} must have an upper bound greater than its lower bound',
        invalidTierRate: 'Tier {index} must have a commission rate between 0 and 100',
        overlappingTier: 'Tier {index} overlaps with the previous tier',
        openEndedTierMustBeLast: 'Tier {index} cannot come after an open-ended tier',
        monthlySnapshotHint: 'Changes only take effect from the next commission month. Records already created this month settle by the frozen snapshot (spec §8.4).'
      },
      ...
      withdrawAll: 'All',
      createOrderAndAudit: 'Create order record and audit log',
      currentBalance: 'Current Balance',
      ...
      auditLogsTip: 'Click to view audit logs',
      auditLogsTitle: 'User Order Audit Logs',
      noAuditLogs: 'No audit logs',
      auditOrderId: 'Order ID',
      auditOrderType: 'Order Type',
      auditPaymentType: 'Payment Method',
      auditAmount: 'Amount',
      auditPayAmount: 'Pay Amount',
      auditStatus: 'Status',
      auditAction: 'Action',
      auditDetail: 'Detail',
      ...
      giftBalance: 'Gift Balance',
      giftRemaining: 'Remaining',
      giftExpiresAt: 'Expires at',
      giftSource: {
        referral_invitee: 'Invitee Registration Reward',
        referral_inviter: 'Inviter Reward',
        referral_ongoing: 'Ongoing Recharge Reward',
        referral_invitee_first_charge: 'Invitee First Charge Reward',
    ...
    groups: {
      ...
      mediaModelsLoadFailed: 'Media models could not be loaded. Historical grants will not be classified or removed in this session.',
      manageMediaModels: 'Open the Media Model Registry',
      mediaModelsSelected: '{count} media model(s) granted',
      unavailableMediaModelsHint: 'These historical grants point to models that are not ready and can be safely removed from the group.',
      removeUnavailableMediaModel: 'Remove grant',
      unavailableMediaModelsSelected: '{count} historical unavailable grant(s)',
    ...
    accounts: {
      ...
      mediaConfig: {
        ...
        description: 'Configure canonical models and upstream IDs. The system resolves adapters from model vendor plus canonical model; accounts never enter one.',
        provider: 'Upstream Provider',
        providerPlaceholder: 'For example, volcengine, xai, or google',
        providerHint: 'Identifies the upstream service account. It does not participate in adapter resolution.',
        ...
        registryModelHint: 'System adapter: {adapter} ({match}); sync: {sync}, native async: {native}, content fetch: {content}',
        legacyModelUnavailable: 'This historical model is disabled or its adapter is not ready. Disable or remove the binding before saving.',
        modeCapabilityMismatch: 'The selected upstream execution mode exceeds the system Adapter capabilities.',
      ...
      rebuildSchedulerCache: 'Rebuild Scheduler Cache',
      rebuildSchedulerCacheRunning: 'Rebuilding...',
      rebuildSchedulerCacheSuccess: 'Scheduler cache rebuild completed',
      ...
      types: {
        ...
        soraApiKeyHint: 'Connect to another FluxCode or compatible API',
        soraBaseUrlRequired: 'Sora API Key account requires a Base URL',
        soraBaseUrlInvalidScheme: 'Base URL must start with http:// or https://',
        upstream: 'Upstream',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another FluxCode instance.',
      ...
      openaiImagePromptLabel: 'Image prompt',
      openaiImagePromptPlaceholder: 'Example: Generate an orange cat astronaut sticker in pixel-art style on a solid background.',
      openaiImagePromptDefault: 'Generate a clean product-style OpenAI image test on a simple background.',
      openaiImageTestHint: 'When an OpenAI image model is selected, this test sends a real image-generation request and previews the returned image below.',
      openaiImageTestMode: 'Mode: OpenAI image generation test',
      openaiImagePreview: 'Generated images:',
      openaiImageReceived: 'Received test image #{count}',
      soraUpstreamBaseUrlHint: 'Upstream Sora service URL (another FluxCode instance or compatible API)',
    ...
    // Promotions (Recharge & Subscription Campaigns)
    promotions: {
      title: 'Promotion Management',
      description: 'Create and manage recharge and subscription promotions',
      ...
      // Form
      name: 'Name',
      namePlaceholder: 'e.g. Summer Recharge Bonus',
      descriptionLabel: 'Description',
      descriptionPlaceholder: 'Promotion description',
      promotionType: 'Promotion Type',
      discountMode: 'Discount Mode',
      reducePay: 'Reduce Payment',
      bonusCredit: 'Bonus Credit',
      rechargeSettings: 'Recharge Settings',
      rechargeRate: 'Payment Rate',
      rechargeRateHint: '0.8 = pay 80%',
      rechargeBonusRate: 'Bonus Rate',
      rechargeBonusRateHint: '0.2 = extra 20%',
      // Plan rules
      planRules: 'Plan Discount Rules',
      addPlanRule: 'Add Rule',
      noPlanRules: 'No plan rules configured. Click "Add Rule" to create one.',
      planRulesCount: 'rules',
      plan: 'Plan',
      selectPlan: 'Select a plan',
      discountByRate: 'Percentage',
      discountByAmount: 'Fixed Amount',
      discountRate: 'Discount Rate',
      discountRateHint: '0.8 = 80% of original',
      ...
      deleteConfirm: 'Are you sure you want to delete this promotion? This action cannot be undone.',
      failedToLoad: 'Failed to load promotions',
      failedToSave: 'Failed to save promotion',
      failedToDelete: 'Failed to delete promotion',
      failedToToggle: 'Failed to toggle promotion status',
      failedToLoadUsages: 'Failed to load usage records'
    },
    ...
    generatedImages: {
      ...
      description: 'Browse images generated and stored by the current site',
      refresh: 'Refresh',
      preview: 'Preview',
      closePreview: 'Close preview',
      failedToLoad: 'Failed to load generated images',
      failedToLoadImage: 'Failed to load image',
      emptyTitle: 'No generated images yet',
      emptyDescription: 'Images generated by the current site will appear here.',
      prompt: 'Prompt',
      ...
      userEmailPlaceholder: 'Search user email',
      ...
      resetFilters: 'Reset',
      cleanup: 'Clear',
      cleanupConfirmTitle: 'Clear Generated Images',
      cleanupConfirmMessage: 'Clear generated image data from {start} to {end}? This only deletes rows in the image archive table and cannot be undone.',
      cleanupConfirmSubmit: 'Clear',
      cleanupMissingRange: 'Select both start date and end date first',
      cleanupSuccess: 'Cleared {count} generated image records',
      cleanupFailed: 'Failed to clear generated image data',
      metadata: 'Metadata',
      ownership: 'Ownership',
      request: 'Request',
      contentType: 'Content Type',
      ...
      failedToLoadGroups: 'Failed to load channel groups'
    },
    ...
    settings: {
      ...
      mediaGeneration: {
        title: 'Media Generation Runtime',
        description: 'Configure synchronous waiting, timeout handling, and video delivery fallback behavior.',
        syncWaitTimeout: 'Synchronous wait timeout (seconds)',
        syncWaitTimeoutHint: 'Set the application-level timer for a synchronous media generation request. Use 0 to disable this timer.',
        timeoutDisabledWarning: '0 disables the application-level timer. This setting alone does not guarantee an automatic switch to asynchronous processing; the asynchronous fallback toggle is independent.',
        fallbackAsync: 'Enable asynchronous fallback after timeout',
        fallbackAsyncHint: 'Allows the runtime to fall back to asynchronous processing when synchronous waiting times out after the request has been submitted upstream.',
        timeoutBillingPolicy: 'Timeout billing policy',
        timeoutBillingPolicyHint: 'Only applies when synchronous waiting times out after the request has already been submitted upstream. It does not apply to queue, Worker, or storage errors.',
        penalty: 'Charge by penalty ratio',
        refund: 'Full refund',
        penaltyRatio: 'Penalty charge ratio',
        penaltyRatioHint: 'Percentage charged only for synchronous wait timeouts after upstream submission. Range: 0%–100%.',
        videoStorageMode: 'Video storage mode',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for FluxCode end-user login',
      ...
      payment: {
        ...
        modeWap: 'Mobile Web',
        modeAuto: 'Auto',
        modeAlipayQRCodeHint: 'Face-to-Face Payment (recommended): always returns a QR code on every device. Mobile users can long-press to save it or scan with another device. Only requires the "Face-to-Face Payment" product.',
        modeAlipayWapHint: 'Mobile Site Payment: every device redirects directly to Alipay. Only use this if your merchant has the "Mobile Site Payment" product activated, otherwise mobile users will hit Alipay\'s error page.',
        modeAlipayAutoHint: 'Auto: mobile devices use Mobile Site Payment (redirect), desktop uses Face-to-Face Payment (QR). Only use this if both products are activated.',
        ...
        configRepairRequired: 'This config cannot be decrypted. Re-enter the full config and save to repair it.',
        ...
        orderIdPrefixHint: 'Used for payment provider order IDs and only affects new orders. Letters, numbers, underscore, and hyphen only; max 16 chars',
        orderIdPreview: 'Order ID Preview',
        preview: 'Preview',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to FluxCode',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">FluxCode is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of FluxCode, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to FluxCode',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the FluxCode AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    qr: {
      ...
      alipayAlertTitle: 'Please use Alipay to scan',
      wxpayAlertTitle: 'Please use WeChat to scan',
    ...
    rechargeAmountMinHint: 'Minimum single recharge: {min}',
    rechargeAmountMaxHint: 'Maximum single recharge: {max}',
    rechargeAmountRangeHint: 'Recharge range: {min} - {max}',
    amountBelowRechargeMin: 'Your input {amount} is below the minimum single recharge {min}',
    amountExceedsRechargeMax: 'Your input {amount} exceeds the maximum single recharge {max}',
    methodAmountTooLow: 'The current payment method requires at least {min}',
    methodAmountTooHigh: 'The current payment method supports up to {max}',
    ...
    promoBonus: 'Bonus Credit',
    promoCredited: 'Final Credited',
    promoActualPay: 'Actual Payment',
    usePromotion: 'Use promotion',
    selectPromotion: 'Promotions (optional)',
    promoModeDiscount: 'Discount',
    promoModeBonus: 'Bonus',
    promoRemaining: '{n} left',
    ...
    renewNow: 'Renew',
    subscriptionModeTitle: 'Choose renewal mode',
    subscriptionModeDesc: 'You already have an active subscription in this group. Choose how this purchase should take effect.',
    subscriptionModeExtend: 'Extend expiry',
    subscriptionModeExtendDesc: 'Extend by {days} days from the current expiry. Quota multiplier stays unchanged',
    subscriptionModeStack: 'Stack quota',
    subscriptionModeStackDesc: 'Stack quota from now for {days} days. Quota multiplier +1',
