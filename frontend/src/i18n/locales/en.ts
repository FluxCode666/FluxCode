export default {
  ...
  keys: {
    ...
    importToCherryStudio: 'Cherry Studio',
    importToChatbox: 'Chatbox',
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
    ...
    clientTypeSelect: {
      ...
      claude: 'Claude',
      claudeDesc: 'Import a Claude API configuration',
      gemini: 'Gemini',
      geminiDesc: 'Import a Gemini API configuration',
    },
  ...
  admin: {
    ...
    accounts: {
      ...
      embedding: {
        baseUrlHint: 'Enter a public or private HTTP/HTTPS OpenAI-compatible embedding endpoint',
