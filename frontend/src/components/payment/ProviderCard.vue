...
import { PAYMENT_MODE_QRCODE, PAYMENT_MODE_POPUP, PAYMENT_MODE_WAP, PAYMENT_MODE_AUTO } from './providerConfig'
...
const modeLabel = computed(() => {
  switch (props.provider.payment_mode) {
    case PAYMENT_MODE_QRCODE: return t('admin.settings.payment.modeQRCode')
    case PAYMENT_MODE_POPUP: return t('admin.settings.payment.modePopup')
    case PAYMENT_MODE_WAP: return t('admin.settings.payment.modeWap')
    case PAYMENT_MODE_AUTO: return t('admin.settings.payment.modeAuto')
    default: return ''
  }
})
