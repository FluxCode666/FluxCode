<template>
  ...
  <!-- OpenAI logo -->
  <svg v-else-if="platform === 'openai' || platform === 'codex2api'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path
  ...
  <!-- Embedding logo (vector layers) -->
  <svg v-else-if="platform === 'embedding'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
