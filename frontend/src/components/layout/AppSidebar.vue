<template>
  ...
  >
    <!-- Logo/Brand -->
    <router-link to="/home" class="sidebar-header cursor-pointer" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/providers', label: t('nav.providers'), icon: ServerIcon },
  ...
  if (authStore.isSimpleMode) {
    ...
    filtered.push({ path: '/api-docs', label: t('nav.apiDocs'), icon: DocumentIcon })
