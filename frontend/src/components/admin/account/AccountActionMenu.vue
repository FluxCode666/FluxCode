      ...
      >
        <div class="py-1">
          <template v-if="account">
            <button v-if="account.platform !== 'media'" @click="$emit('test', account); $emit('close')" class="flex w-full items-center gap-2 px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-dark-700">
            ...
            <button v-if="account.platform !== 'media'" @click="$emit('schedule', account); $emit('close')" class="flex w-full items-center gap-2 px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-dark-700">
